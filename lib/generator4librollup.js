...
exports.Generator4LibRollup = void 0;
...
const TEMPLATES = path_1.join(constant_1.GENERATOR_DIR, 'templates', 'lib-rollup');
// const PROMPTS = [
//   {
//     name: 'preprocessor',
...
//   }
// ];
class Generator4LibRollup extends yeoman_generator_1.default {
    constructor(name) {
        super([], {
...
exports.Generator4LibRollup = Generator4LibRollup;
