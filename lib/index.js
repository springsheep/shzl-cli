...
const generator4wechat_1 = require('./generator4wechat')
...
const PROMPTS = [
  ...
  },
  {
    ...
    name: 'platform',
    message: '平台类型',
    choices: ['miniapp', 'pc', 'mobile', 'lib-rollup', 'antvue', 'dd', 'wechat'],
  },
]
async function run() {
  ...
  try {
    ...
    switch (platform) {
      ...
      case 'wechat': {
        // 微信小程序的模版生成
        generator = new generator4wechat_1.Generator4wechat(name)
        break
      }
