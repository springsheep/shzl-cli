...
const TEMPLATES = path_1.join(constant_1.GENERATOR_DIR, 'templates', 'pc');
// const PROMPTS = [
//   {
//     name: 'preprocessor',
...
//   }
// ];
class Generator4pc extends yeoman_generator_1.default {
   constructor(name) {
      super([], {
...
exports.Generator4pc = Generator4pc;
