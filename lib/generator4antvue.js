...
exports.Generator4AntVue = void 0;
...
const TEMPLATES = path_1.join(constant_1.GENERATOR_DIR, 'templates', 'antvue');
// const PROMPTS = [
//   {
//     name: 'preprocessor',
...
//   }
// ];
class Generator4AntVue extends yeoman_generator_1.default {
   constructor(name) {
      super([], {
...
exports.Generator4AntVue = Generator4AntVue;
